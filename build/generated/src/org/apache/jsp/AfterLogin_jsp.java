...
public final class AfterLogin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_p_form_0(PageContext _jspx_page_context)
    ...
    _jspx_th_p_form_0.setAction("/log3");
    ...
    if (_jspx_eval_p_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("            <tr>\n");
        out.write("                <td width=\"823\" height=\"427\" valign=\"top\" background=\"img/bggif.gif\">\n");
        out.write("            <center><label>FILTER BY</label>\n");
        out.write("        <select name=\"select\">\n");
        out.write("            <option>Select</option>\n");
        out.write("             <option value=\"Name\">Name</option>\n");
        out.write("            <option value=\"Placements\">Placement</option>\n");
        out.write("            <option value=\"Ranking\">Ranking</option>\n");
        out.write("             <option value=\"States\">States</option>\n");
        out.write("             <option value=\"Fees\">Fees</option>\n");
        out.write("        </select>\n");
        out.write("                <input type=\"submit\" value=\"Submit\"/></center></td></table>\n");
        out.write("    \n");
        out.write("        ");
